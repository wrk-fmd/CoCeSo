...
<div class="navbar navbar-default" role="navigation">
  ...
  <div class="navbar-collapse collapse">
    <form action="<c:url value="/patadmin/postprocessing/search"/>" class="navbar-form navbar-right" method="get">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="<c:url value="/patadmin/postprocessing"/>"><spring:message code="patadmin.postprocessing"/></a></li>
