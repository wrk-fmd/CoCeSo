...
<html>
<head>
  <t:head maintitle="patadmin" title="patient.edit" entry="navbar"/>
</head>
<body>
<div class="container">
  ...
  <div class="clearfix">
    <form:form method="post" servletRelativeAction="/patadmin/treatment/save" acceptCharset="utf-8">
      <form:hidden path="patient" data-bind="valueInit: patient"/>
      <h3 class="page-header">
        <spring:message code="patient.personal"/>
        <c:if test="${command.patient != null}">
          #${command.patient}
        </c:if>
      </h3>
      <div class="clearfix">
      ...
      <c:if test="${command.patient == null}">
        <form:button class="btn btn-default" name="transport" value="true"><spring:message code="patient.requesttransport"/></form:button>
      </c:if>
    </form:form>
  </div>
</div>
