...
<head>
    ...
    <t:head maintitle="patadmin" title="${empty command.patient ? 'patient.add' : 'patient.edit'}"
            entry="patadmin_form"/>
</head>
<body>
<div class="container">
    ...
    <div class="clearfix">
        <div class="col-md-7">
            <form:form method="post" servletRelativeAction="/patadmin/registration/save" acceptCharset="utf-8" autocomplete="off">
                <form:hidden path="patient" data-bind="valueInit: patient"/>
                <h3 class="page-header"><spring:message code="patient.personal"/>
                    <c:if test="${not empty command.patient}">
                        <span class="text-danger">#<c:out value="${command.patient}"/></span>
                    </c:if>
                </h3>
                <div class="clearfix">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <form:input path="firstname" cssClass="form-control nosubmit"
                                    data-bind="valueInit: firstname, ${empty command.patient ? 'patient: {key: \\\'firstname\\\', callback: callback}' : ''}"/>
                    </div>
                    <div class="form-group col-md-6">
