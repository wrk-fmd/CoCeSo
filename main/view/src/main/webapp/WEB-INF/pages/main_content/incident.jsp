...
<div class="ajax_content">
  <div class="filter"
       data-bind="accordion: {active: false, collapsible: true, heightStyle: 'content'}, if: (disableFilter !== true)">
    ...
    <div>
      ...
      <div class="form-group" data-bind="visible: (disableFilter.patient !== true)">
        <label><spring:message code="incident.casus"/>:</label>
        <div class="clearfix">
          <div class="checkbox-inline">
            <label>
              <input type="checkbox" value="true" data-bind="checked: filter.isCasusNrSet"/>
              <spring:message code="yes"/>
            </label>
          </div>
          <div class="checkbox-inline">
            <label>
              <input type="checkbox" value="false" data-bind="checked: filter.isCasusNrSet"/>
              <spring:message code="no"/>
            </label>
          </div>
        </div>
      ...
      <div class="form-group" data-bind="visible: (disableFilter.patient !== true)">
        <label><spring:message code="patient"/>:</label>
        <div class="clearfix">
          <div class="checkbox-inline">
            <label>
              <input type="checkbox" value="true" data-bind="checked: filter.hasPatientAssigned"/>
              <spring:message code="yes"/>
            </label>
          </div>
          <div class="checkbox-inline">
            <label>
              <input type="checkbox" value="false" data-bind="checked: filter.hasPatientAssigned"/>
              <spring:message code="no"/>
            </label>
          </div>
        </div>
  ...
  <ul data-bind="foreach: filtered, accordion: {active: false, collapsible: true, heightStyle: 'content'}, accordionRefresh: filtered">
    <li data-bind="droppable: {drop: assignUnitList, tolerance: 'pointer'}">
      ...
      <div>
        ...
        <p>
          <button type="button" class="btn btn-default" data-bind="click: openForm"><spring:message code="edit"/></button>
        </p>
        <p>
          <a href="#" class="btn btn-default btn-xs" title="<spring:message code="log.add"/>" data-bind="click: addLog">
            <spring:message code="log.add"/>
          </a>
          <a href="#" target="_blank" class="btn btn-default btn-xs" title="<spring:message code="log.view"/>"
             data-bind="attr: {href: '<c:url value="/dashboard?iid="/>' + id}">
