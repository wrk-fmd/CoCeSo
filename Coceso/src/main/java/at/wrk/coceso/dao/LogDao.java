...
public class LogDao extends CocesoDao<LogEntry> {
    ...
    public int add(LogEntry l) {
        ...
        jdbc.update(q, new Timestamp(System.currentTimeMillis()), l.getConcern().getId(), l.getUnit() == null ? null : l.getUnit().getId(),
                l.getIncident() == null ? null : l.getIncident().getId(), state == null ? null : state.name(),
                l.isAutoGenerated(), l.getUser().getId(), l.getText(), l.getJson());
