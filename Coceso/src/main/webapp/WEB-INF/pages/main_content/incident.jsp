...
<div class="ajax_content">
    <div class="ui-tabs" data-bind="buttonset: {}, visible: showTabs">
        <input id="tab_emergency" type="radio" name="tab" value="0" data-bind="checked: selectedTab" /> <label for="tab_emergency"><spring:message code="label.main.emergency" /></label>
        <input id="tab_tasks" type="radio" name="tab" value="1" data-bind="checked: selectedTab" /> <label for="tab_tasks"><spring:message code="label.incident.type.task" /></label>
        <input id="tab_relocations" type="radio" name="tab" value="2" data-bind="checked: selectedTab" /> <label for="tab_relocations"><spring:message code="label.incident.type.relocation" /></label>
    </div>
