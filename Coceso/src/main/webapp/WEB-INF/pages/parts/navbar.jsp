...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<c:url value="/"/>"><spring:message code="label.coceso"/></a>
    </div>
    <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="${nav_main}"><a href="<c:url value="/main/"/>"><strong><spring:message code="label.nav.main"/></strong></a></li>
        </ul>
