          ...
          default:
            if (ko.isWriteableObservable(mappedRootObject)) {
              ...
              if (hasCreateCallback()) {
                ...
                //CHANGED dro
                var observeOptions = {};
                if (typeof options.orig !== "undefined") {
                  ...
                  for (i = 0; i < path.length; i++) {
                    ...
                    observeOptions.orig = observeOptions.orig[path[i]];
                  }
                }
                mappedRootObject = ko.observable(ko.utils.unwrapObservable(rootObject)).extend({observeChanges: observeOptions});
                //END CHANGES
              }
