...
public class AlarmTextControllerTest {
    ...
    public void sendAlarmText_noIncidentId_returnError() {
        ...
        SendAlarmTextResponse response = sut.sendAlarmText(request, locale);
    ...
    public void sendAlarmText_serviceReturnsNoGatewayErrorResult_returnError() {
        ...
        when(alarmTextService.sendAlarmText(request.getIncidentId(), request.getAlarmText(), request.getType(), locale))
