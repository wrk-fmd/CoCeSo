...
public class AlarmTextTargetFactory {
    private static final Logger LOG = LoggerFactory.getLogger(AlarmTextTargetFactory.class);
    ...
    public AlarmTextTargetFactory(
            ...
            final List<NumberNormalizer> numberNormalizers) {
        this.incidentService = incidentService;
        this.numberNormalizers = numberNormalizers.stream().collect(toMap(NumberNormalizer::getSupportedUriSchema, Function.identity()));
    ...
    public Map<String, List<String>> createTargetList(final int incidentId, final AlarmTextType type) {
        ...
        if (incident != null) {
            ...
            Map<String, List<String>> validTargets = unitStream
