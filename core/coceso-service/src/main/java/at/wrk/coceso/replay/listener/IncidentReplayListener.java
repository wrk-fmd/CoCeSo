...
@RabbitListener(bindings = @QueueBinding(
        ...
        key = CocesoExchangeNames.STOMP_INCIDENTS
))
class IncidentReplayListener extends AbstractReplayListener {

    @Autowired
    public IncidentReplayListener(EventBus eventBus) {
        super(eventBus, CocesoExchangeNames.STOMP_INCIDENTS);
    }
}
