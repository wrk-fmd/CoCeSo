...
@RabbitListener(bindings = @QueueBinding(
        ...
        key = CocesoExchangeNames.STOMP_CONTAINERS
))
class ContainerReplayListener extends AbstractReplayListener {

    @Autowired
    public ContainerReplayListener(EventBus eventBus) {
        super(eventBus, CocesoExchangeNames.STOMP_CONTAINERS);
    }
}
