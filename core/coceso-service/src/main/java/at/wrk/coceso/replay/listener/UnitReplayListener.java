...
@RabbitListener(bindings = @QueueBinding(
        ...
        key = CocesoExchangeNames.STOMP_UNITS
))
class UnitReplayListener extends AbstractReplayListener {

    @Autowired
    public UnitReplayListener(EventBus eventBus) {
        super(eventBus, CocesoExchangeNames.STOMP_UNITS);
    }
}
