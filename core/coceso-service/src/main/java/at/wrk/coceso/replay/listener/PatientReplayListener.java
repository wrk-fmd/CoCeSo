...
@RabbitListener(bindings = @QueueBinding(
        ...
        key = CocesoExchangeNames.STOMP_PATIENTS
))
class PatientReplayListener extends AbstractReplayListener {

    @Autowired
    public PatientReplayListener(EventBus eventBus) {
        super(eventBus, CocesoExchangeNames.STOMP_PATIENTS);
    }
}
